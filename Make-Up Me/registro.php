<?php 
	...
	if (isset($_POST['registro'])) {
		...
		if ($pass1 == $pass2 && $pass1 != "" && $pass2 != "" && $nombre != "" && $mail != "") {
			...
			$insert ="INSERT INTO usuarios (Nombre, Apellidos, Correo, Password) VALUES('$nombre', '$apellidos', '$mail', md5('$pass1'));";
...
<form action="#" method="POST">
	...
	<a target="_blank" href="https://www.youtube.com">Términos y Condiciones</a><br><br><br>
