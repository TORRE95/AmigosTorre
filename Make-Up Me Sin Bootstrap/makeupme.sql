...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-03-2018 a las 07:15:48
...
INSERT INTO `estilistas` (`idEstilista`, `Nombre`, `Apellidos`, `nombreTienda`, `Ubicacion`, `Distancia`, `Descripcion`, `Contacto`, `Calificacion`, `Foto`) VALUES
(1, 'Liliana', 'Osornio González', 'MakeUp Artist & Hairstyle', 'Guanajuato', '1.5', 'Liliana Osornio Gonzalez , especialista en novias es una talentosa profesional que ofrece sus servicios para todas aquellas personas que deseen sacar su belleza natural a la luz y verse realmente bellas. Su especialidad son las novias, ya que conoce todos los secretos que se necesitan para un maquillaje de boda perfecto. No lo duden ni un segundo y confíen plenamente en la sensibilidad y creatividad de este gran maquillista.\nServicios que ofrece\n\nLiliana Osornio especialista en novias ofrece servicios de;\nPrueba de maquillaje y peinado\nAsesoría de imagen\nMaquillista Profesional, uso las mejores marcas: Atelier, Mac, Younique...Maquillaje social, novia, XV años, graduadas...Servicio a domicilio.4611777088', 'www.facebook.com/MakeUpArtist&Hairstyle', '4.5', 'images/est5.jpg'),
(2, 'Katty ', 'Pyrre', 'Design Me', 'Celaya, Guanajuato', '1.8', 'No necesitamos descripción, ya nos conoces. Somos los mejores del estado, ven y comprueba', 'www.facebook.com/designMe', '5.0', 'images/est4.jpg'),
(3, 'Daniela', 'Serrato Ramírez', 'Major Make up', 'San Luis Potosí', '2.0', 'Si desean lucir hermosas y radiantes eneventos sociales, la maquillista profesional Daniela Serrato les ofrecerá un servicio de calidad garantizada cuidando cada detalle. Para esta profesional, su belleza es sumamente importante, pues sabe que deben lucir hermosas y seguras.\nServicios que ofrece:\nDaniela Serrato pondrá a su disposición un excelente paquete de servicios para cualquier evento social. Cuentan con servicio para novias, XV años y eventos sociales. El trabajo de esta profesional es fino y bien cuidado. Cuentan con servicio de maquillaje en alta definición para las fotos y alto peinado. Incluye:\nAsesoría de imagen\nPrueba de maquillaje \nAplicación de pestañas postizas\nMaquillaje de larga duración\nLabiales indelebles\n', 'www.facebook.com/MajorMakeUpOficial', '4.8', 'images/est3.jpg');
