<?php 
	...
	function iniciarSesion()
	{
		...
		if(isset($_POST['iniciar'])){
			...
			//Buscar en BD
			$buscar = "SELECT COUNT(*) AS Total FROM usuarios WHERE Correo = '$num' AND Password = md5('$pass') ;";
			...
			if($total['Total'] > 0){
				...
				$datosUsuario = "SELECT * FROM usuarios WHERE Correo = '$num' AND Password = md5('$pass');";
